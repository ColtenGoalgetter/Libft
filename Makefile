...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2021/10/25 17:27:37 by joaribei          #+#    #+#              #
#    Updated: 2021/12/06 22:04:27 by edos-san         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BONUS_SRCS	= 		ft_lstsize.c ft_lstlast.c ft_lstadd_front.c ft_lstadd_back.c 		\
